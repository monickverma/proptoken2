      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-900 p-10 rounded-2xl border-2 border-slate-100 dark:border-slate-800">
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-[10px] font-black uppercase tracking-widest">
            <span className="bg-white dark:bg-slate-900 px-4 text-slate-400">Or join with</span>
          </div>
        </div>
        ...
        <p className="mt-4 text-center text-[10px] font-black text-slate-400 uppercase tracking-widest">
          Already verified? <Link to="/signin" className="text-indigo-600 dark:text-indigo-400 hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  );
